...
enum Texturas_t {
	...
	TObjetoEquipo2, TPantallaTrucos, TEscondite, TObstaculoPiedra, TCarroña, THuellasCamino, TValla, TArbol2, TArbol3A, TArbol3B, TBroom, TBucket, TObs1, TObs2, TCabaBoot, TCabaBoDo,
	TCabaDomo, TPozoA, TPozoB, 
};
